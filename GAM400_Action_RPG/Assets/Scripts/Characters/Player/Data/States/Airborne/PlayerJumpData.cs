...
namespace BattleZZang
{
    ...
    public class PlayerJumpData
    {
        ...
        [field: SerializeField] [field: Range(0f, 5f)] public float JumpToGroundRayDistance { get; private set; } = 2.0f;
        [field: SerializeField] public AnimationCurve JumpForceModiferBySlopeMoveUp { get; private set; }
        [field: SerializeField] public AnimationCurve JumpForceModiferBySlopeMoveDown { get; private set; }
